...
{
    public partial class CNotificaciones : BPage
    {
        #region Eventos
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack != true)
            {
                Session["dtRelAl"] = ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;1|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                ...
                case "Nuevo":
                    {
                        ...
                        if (dt.Rows[0][0].ToString() == "##" & gvRelAlert.Rows.Count == 1)
                        {
                            ...
                            gvRelAlert.DataSource = dt;
                            gvRelAlert.DataBind();
                            var dtTCri = (DataTable)ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;3", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            var dtSta = (DataTable)ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;4", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            LdDdlGv(gvRelAlert, dtTCri, "ddlTAlert|IdTN|DescTN", 1);
                ...
                case "Editar":
                    {
                        ...
                        if (dt.Rows[0][0].ToString() != "##")
                        {
                            ...
                            var dtTCri = (DataTable)ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;3", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            var dtSta = (DataTable)ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;4", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            var dtRaId = (DataTable)ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;2|@IDCEN;" + gvRelAlert.Rows[int.Parse(e.CommandArgument.ToString())].Cells[0].Text + "", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            LdDdlGv(gvRelAlert, dtTCri, "ddlTAlert|IdTN|DescTN", 2, dtRaId, "0|1");
                            LdDdlGv(gvRelAlert, dtSta, "ddlSta|IDSTARG|STATXT", 2, dtRaId, "0|5");
                ...
                case "Guardar":
                    {
                        ...
                        var dMod = gvRelAlert.Rows[Convert.ToInt32(e.CommandArgument.ToString())].Cells[3].Text.Trim();
                        var tMod = gvRelAlert.Rows[Convert.ToInt32(e.CommandArgument.ToString())].Cells[4].Text.Trim();
                        ...
                        switch (((int)Session["RANew"]))
                        {
                            case 0:
                                {
                                    var res = 0;
                                    if (IdAl != "##" & int.TryParse(IdAl, out res) & int.TryParse(IdTCri, out res) & int.TryParse(IdStaA, out res))
                                    {
                                        lblEInsUp.Visible = false;
                                        res = (int)ECmSp("SPSIU_CEN|@TCOM;3|@TTAB;1|@IDCEN;" + IdAl.Trim() + "|@IDTN;" + IdTCri.Trim() + "|@CEMEXID;" + IdMsg.Trim() + "|@DMOD;" + String.Format("{0:yyyy-MM-dd}", DateTime.Today) + "|@TMOD;" + String.Format("{0:HH:mm:ss}", DateTime.Now) + "|@IDSTARG;" + IdStaA.Trim() + "", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 2);
                                        if (res == 1)
                                        {
                                            Session["dtRelAl"] = ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;1|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                                        }
                            ...
                            case 1:
                                {
                                    var res = 0;
                                    if (int.TryParse(IdTCri, out res) & int.TryParse(IdStaA, out res))
                                    {
                                        ECmSp("SPSIU_CEN|@TCOM;2|@TTAB;1|@IDTN;" + IdTCri.Trim() + "|@CEMEXID;" + IdMsg.Trim() + "|@IDSTARG;" + IdStaA.Trim() + "|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais + "|@USRCONFIG;" + ((IUsr)Session["Usr"]).usr.CemexId, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 0);
                                        Session["dtRelAl"] = ECmSp("SPSIU_CEN|@TCOM;1|@TTAB;1|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                                        gvRelAlert.EditIndex = -1;
                                        gvRelAlert.DataSource = Session["dtRelAl"];
                                        gvRelAlert.DataBind();
        ...
        protected void lbtnIdMsgRel_Click(object sender, EventArgs e)
        {
            ...
            Session["dtAlBusq"] = ECmSp("SPSIU_CEN|@TCOM;4|@TTAB;1|@IDSTARG;1|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais + "|@IDROL;" + ((IUsr)Session["Usr"]).usr.Rol.IdRol, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
        ...
        protected void btnBusq_Click(object sender, EventArgs e)
        {
            ...
            if (txtMSGBusq.Text != "" | txtIdBusq.Text != "")
            {
                ...
                {
                    Session["dtABCon"] = ECmSp("SPSIU_CEN|@TCOM;4|@TTAB;2|@IDSTARG;1|@NUSUARIO;" + txtMSGBusq.Text.Trim() + "|@IDPAIS;" + ((IUsr)Session["Usr"]).usr.Pais.IdPais + "|@IDROL;" + ((IUsr)Session["Usr"]).usr.Rol.IdRol, System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
            ...
            {
                lblEBusq.Text = "Ingrese el CemexID o el Nombre del Usuario";
