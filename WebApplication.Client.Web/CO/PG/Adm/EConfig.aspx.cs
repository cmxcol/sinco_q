    ...
    public partial class EConfig : BPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                if (((IUsr)Session["Usr"]).usr.Rol.IdRol != 3 ) {
                ...
                case "Nuevo":
                    {
                        ...
                        if (dt.Rows[0][0].ToString() == "##" & gvExCli.Rows.Count == 1)
                        {
                            ...
                            var dtTSeg = (DataTable)ECmSp("SPSIT_CE|@IDCON;7|@TTAB;6|@idpais;1", System.Configuration.ConfigurationManager.ConnectionStrings["cnnCOS"].ToString(), 1);
                            LdDdlGv(gvExCli, dtTSeg, "ddlTSegmento|Id_Segm|Segmento", 1);
                            ((LinkButton)gvExCli.Rows[gvExCli.EditIndex].FindControl("lbtnIdEmpAuthC")).Text = "Buscar";
                ...
                case "Guardar":
                    {
                        ...
                        var Tipo_Segmento = ((DropDownList)gvExCli.Rows[Convert.ToInt32(e.CommandArgument.ToString())].FindControl("ddlTSegmento")).SelectedValue;
        ...
        protected void ddlTSeg_SelectedIndexChanged(Object sender, EventArgs e)
        {
